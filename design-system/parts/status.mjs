...
export const css = `
  ...
  .callout__body{flex:1;min-width:0} .callout__title{display:block;font-weight:var(--font-weight-semibold)} .callout__text{display:block;color:var(--fg-neutral-subtle)}
